...
ActiveRecord::Schema[8.0].define(version: 2026_09_22_130000) do
  ...
  create_table "forum_topics", force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_forum_topics_on_slug_unique", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index "lower((pending_email_address)::text)", name: "index_users_on_lower_pending_email", where: "(pending_email_address IS NOT NULL)"
